...
```
This takes a function and calls it in an asynchronous function, executing it asynchronously.
...
That's it, I like to experiment with different styles to see if they make code more readable.
...
[^1]: Well, It depends, If you have huge synchronous task, you don't wanna hog the
    event-loop, you might consider to divide the work into smaller chunks and
